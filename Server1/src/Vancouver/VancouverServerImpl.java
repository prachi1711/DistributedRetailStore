...
public class VancouverServerImpl implements RetailStoreOperations{
									...
									if(islockedT && islockedM)							
									{
						             ...
						             if(totalItemsAvailable >= numberOfItem)
						             {
						            	 ...
						            	 else
						            	 {
						            		 ...
						            		 orderItemFromOtherStore(itemID,itemsAvailableWithTServer,4002);
						            		 orderItemFromOtherStore(itemID,tempNo,4001);
						            	 }
						            	 buyStatus = true;
						             }
						             else
															...
															if(islockedT && islockedM)							
															{
												             ...
												             if(totalItemsAvailable >= desiredNumber)
												             {
												            	 ...
												            	 else
												            	 {
												            		 ...
												            		 orderItemFromOtherStore(desiredItemID,itemsAvailableWithTServer,4002);
												            		 orderItemFromOtherStore(desiredItemID,tempNo,4001);
												            	 }
												            	 buyStatus = true;
												             }
												             else
	 ...
	 */
		...
		public static void main(String[] args) 
		{
			try
		    {  						
				DatagramSocket rmSocket = new DatagramSocket(4007); // create a socket to bind with replica Manager using UDP
				byte[] receiveData = new byte[1024];	
